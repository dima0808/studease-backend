...
public class MessageExceptionTranslator {
  ...
  public CustomErrorResponse handleNotFoundException(
      RuntimeException exc, @Header("credentials") String credentials) {
  ...
  public CustomErrorResponse handleBadRequestException(
      RuntimeException exc, @Header("credentials") String credentials) {
    CustomErrorResponse errorResponse =
        CustomErrorResponse.builder()
